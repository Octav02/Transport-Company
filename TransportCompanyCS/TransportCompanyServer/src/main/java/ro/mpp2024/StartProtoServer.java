...
import ro.mpp2024.persistance.dbrepository.BookingDBRepository;
import ro.mpp2024.persistance.dbrepository.TripDbRepository;
import ro.mpp2024.persistance.dbrepository.UserDBRepository;
import ro.mpp2024.services.TransportCompanyService;
import ro.mpp2024.utils.AbstractServer;
import ro.mpp2024.utils.ProtoConcurrentServer;
...
public class StartProtoServer {
    ...
    public static void main(String[] args) {
        ...
        AbstractServer server = new ProtoConcurrentServer(defaultPort, serverImpl);
        try {
            server.start();
        } catch (Exception e) {
